...
<head>
    <title>Platinum FCU - Platinum Star</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <section class="overview-block-ptb1 iq-over-black-10 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-color: #575757;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6 custom-header">Platinum Star</h2>
                    </div>
                </div>
            </div>
        </div>
...
MAIN CONTENT -->
    <div class="main-content">
        <!--=================================
Tabs -->
        <div class="overview-block-ptb iq-tab6" style="background: url(../images/photo-bg1.jpg) no-repeat 100% top;
    background-size: auto;">
            <div class="container">
                <div class="row" style="background: rgba(255,255,255, .9);">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 iq-mtb-15">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active">
                                <div class="row">
                                    <div class="col-sm-12">
										<h3 class="iq-pb-25">You can be PLATINUM famous!</h3>
										<p>Submit your photos to be featured in PFCU's 2024 Calendar.</p>
										
										<p>Have you received an auto loan or mortgage from the credit union? Has PFCU helped you start or grow your business? Maybe you're a PFCU scholarship recipient?</p>
										
										<p>No matter how you've benefitted from the credit union in the past - or hope to benefit in the future - we want to see your success in pictures so we can make you <strong>PLATINUM</strong> famous!</p>
										
										<p><strong>Photo Suggestions:</strong></p>
										
										<ul style="padding-left: 25px;">
											<li>&bull; Your family in front of your new home</li>
											<li>&bull; You holding your PFCU credit card</li>
											<li>&bull; You in the driver's seat of your financed car</li>
											<li>&bull; Your business store front or you hard at work inside</li>
											<li>&bull; You in your graduation robe or sporting your diploma</li>
										</ul>
										
										<br>
										
										<p><strong>Submit your pictures to <a href="mailto:calendar@platinumfcu.org">calendar@platinumfcu.org</a> by October 31st.</strong> Any and all photos are welcome and will be considered for use.</p>
										
										<p><em>*Members must be 18 years or older to submit any photos. By providing your photos you consent to allow Platinum FCU use the image(s) on promotional materials throughout the year.</em></p>
                                    </div>
                                </div>
                            </div>
