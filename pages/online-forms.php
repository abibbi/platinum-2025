...
<head>
    <title>Platinum FCU - Online Applications</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 iq-mtb-15">
                        ...
                        <ul class="nav nav-pills tabs-left" id="pills-tab" >
							...
							<li class="nav-item">
                                <a class="nav-link active" href="online-forms.php">Online Applications</a>
                            </li>
							<li class="nav-item">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 iq-mtb-15">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active">
                                <div class="row">
                                    <div class="col-sm-12">
										<h3 class="iq-pb-25">Online Applications</h3>
										<p align="center"><a class="button iq-mtb-20" href="https://www.shareteccu.com/app/platinumfcu/viewapp?id=72" role="button" target="_blank">New Member Application</a></p>
										
										<p align="center"><a class="button iq-mtb-20" href="https://www.shareteccu.com/app/platinumfcu/viewapp?id=73" role="button" target="_blank">Existing Member New Account &amp; Loan Application</a></p>
										
										<p align="center"><a class="button iq-mtb-20" href="#" role="button" data-remodal-target="memberfirst">Mortgage Loan Application</a></p>
                                    </div>
                                </div>
                            </div>
