...
<head>
    <title>Platinum FCU - Personal Deposit Account Fee Schedule</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <section class="overview-block-ptb1 iq-over-black-10 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-color: #575757;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6 custom-header">Personal Fees &amp; Rates</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 iq-mtb-15">
                        ...
                        <ul class="nav nav-pills tabs-left" id="pills-tab" >
                            <li class="nav-item">
                                <a class="nav-link active" href="personal-fee1.php">Deposit Account Fee Schedule</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" href="personal-rates1.php">Deposit Rates</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="personal-fee2.php">Loans Fee Schedule</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" href="personal-rates2.php">Loan Rates</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" href="personal-fee3.php">Misc. Fee Schedule</a>
                            </li>
                        </ul>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 iq-mtb-15">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active">
                                <div class="row">
                                    <div class="col-sm-12">
										<h3 class="iq-pb-25">Deposit Account Fee Schedule</h3>
										...
										<table class="table table-bordered table-striped">
  											...
  											<tbody>
												...
												<tr>
													...
													<td><a href="personal-rates1.php">See Deposit Rates</a></td>
												</tr>
												<tr>
													<td>Other Fees</td>
													<td><a href="personal-fee3.php">See Miscellaneous Fees</a></td>
												</tr>
  											</tbody>
										</table>
										...
										<table class="table table-bordered table-striped">
  											<thead>
   												<tr>
													<th scope="col" colspan="2" style="background-color: #065e2c; color: #fff;"><center><strong>Personal and Student Checking Account</strong></center></th>
    											</tr>
  											</thead>
  											<tbody>
    											<tr>
												...
												<tr>
													<td>Other Fees</td>
													<td><a href="personal-fee3.php">See Miscelleneous Fees</a></td>
												</tr>
  											</tbody>
										</table>
