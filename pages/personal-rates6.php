									...
									<div class="card">
											...
											<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
												<div class="card-body">
													<div class="row">
                                    <div class="col-sm-12">
										<p><strong>Loan Rates are accurate as of October 2021. Rates and other terms may change at any time without prior notice. For variable rate loans a floor rate may be applicable.</strong></p>
										...
										<div class="card">
											...
											<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
												<div class="card-body">
													<div class="row">
                                    <div class="col-sm-12">
										 <p><strong>Dividend Rate is accurate as of March 2021. Rates and other terms may change at any time without prior notice.</strong></p>
...
$5,000 &amp; above
              ...
              <p><em>*Dividend Rate is accurate as of March 2021. Rates and other terms may change at any time without prior notice. After your certificate is opened, the dividend rate is fixed for the term. A penalty is imposed for early withdrawal. Fees could reduce earnings on the account.</em></p>
          		<table class="table-bordered table-striped" align="center" style="width:95%;">
				  <thead>
          	    <tr>
            ...
            Access your accounts at PFCU 24 hours a day with&nbsp;<a href="../index.php" title="Home Banking" aria-label="Home Banking Login">Home Banking </a>.</p>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <table class="table table-bordered table-striped">
  											<thead>
   												<tr>
													<th scope="col" colspan="2" style="background-color: #065e2c; color: #fff;"><center><strong>Platinum Simple Checking Account</strong></center></th>
    											</tr>
  											</thead>
  											<tbody>
    											<tr>
