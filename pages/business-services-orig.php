                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 iq-mtb-15">
                        ...
                        <ul class="nav nav-pills tabs-left" id="pills-tab" >
                            <li class="nav-item">
                                <a class="nav-link active" id="armored-tab" data-toggle="pill" href="#armored"  aria-controls="armored" aria-selected="true">Armored Car Services</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="estatement-tab" data-toggle="pill" href="#estatement"  aria-controls="estatement" aria-selected="false">E-Statements</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" id="homebanking-tab" data-toggle="pill" href="#homebanking"  aria-controls="homebanking" aria-selected="false">Home Banking</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" id="letter-tab" data-toggle="pill" href="#letter"  aria-controls="letter" aria-selected="false">Letter of Credit</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" id="merchant1-tab" data-toggle="pill" href="#merchant1"  aria-controls="merchant1" aria-selected="false">Merchant Services</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" id="merchant2-tab" data-toggle="pill" href="#merchant2"  aria-controls="merchant2" aria-selected="false">Merchant Capture Services</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" id="nextday-tab" data-toggle="pill" href="#nextday"  aria-controls="nextday" aria-selected="false">Next Day Clearing</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" id="night-tab" data-toggle="pill" href="#night"  aria-controls="night" aria-selected="false">Night Drop Facility</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" id="notary-tab" data-toggle="pill" href="#notary"  aria-controls="notary" aria-selected="false">Notary Services</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" id="overdraft-tab" data-toggle="pill" href="#overdraft"  aria-controls="overdraft" aria-selected="false">Overdraft Protection</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" id="safe-tab" data-toggle="pill" href="#safe"  aria-controls="safe" aria-selected="false">Safe Deposit Box</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" id="shared-tab" data-toggle="pill" href="#shared"  aria-controls="shared" aria-selected="false">Shared Branch Services</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" id="wire-tab" data-toggle="pill" href="#wire"  aria-controls="wire" aria-selected="false">Wire Transfer</a>
                            </li>
                        </ul>
...
<span class="iq-font-yellow iq-pl-10 iq-tw-6 iq-lead"> +1404 297 9797</span><br>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 iq-mtb-15">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="armored" role="tabpanel" aria-labelledby="armored-tab">
                                <div class="row">
                                    <div class="col-sm-12">
										<p>Dunbar's partnership with Atlanta Retailers Association (ARA) and PFCU allows you to take advantage of special rates for integrated cash management solutions. As a full-service security organization Dunbar has developed solid and proven specialized transportation and cash management services that are structured to deliver innovative solutions to fit your special needs.</p>
										<p>Dunbar's cash management services are driven by the Dunbar Cash Manager SafeSM program whereby an electronic smart safe is installed within your store to validate and secure your cash directly at the point-of-sale and remain secure until Dunbar arrives to pickup your deposits. Cash Manager SafeSM users save several hours a day by not having to count cash and prepare daily deposits as the safe prepares your deposit automatically transaction by transaction and is ready when Dunbar arrives to service your location.</p>
										<p>What's more, Dunbar through PFCU can facilitate Advanced CreditSM, giving provisional credit in your PFCU Business Checking Account for cash that remains secured in the safe within your store locations.</p>
										<p>To learn more about our partnership with Dunbar contact Dunbar representative. David Rust - Dunbar Account Executive. O: 770-409-2066; C: 404-886-5647; E: <a href="mailto:David.Rust@dunbararm.com">David.Rust@dunbararm.com</a></p>
										...
										<p align="center"><img src="../images/business/dunbar2.jpg" alt="Armored Car Service"></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="homebanking" role="tabpanel" aria-labelledby="homebanking-tab">
                                <div class="row">
                                    <div class="col-sm-12">
										...
										<p><a href="https://platinumfcu.onlinecu.com/" target="_blank">Click Here to access your Home Banking</a> or call us at 1(877) PFCU4YOU (732-8496).</p>
										<p><strong>You're in control</strong> - To switch back to mailed paper statements: In Home Banking click on Statements tab, click on the "Stop E-Statements" choice.</p>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="letter" role="tabpanel" aria-labelledby="letter-tab">
								...
								<p><a href="business-other.php">Click Here for Fee Schedule</a>.</p>
								<p><strong>Account Access</strong><br>
									Access your accounts at PFCU 24 hours a day with Home Banking.</p>
                            </div>
							
							<div class="tab-pane fade" id="merchant1" role="tabpanel" aria-labelledby="merchant1-tab">
								...
								<p>PFCU has partnered with FIS Merchant Solutions to help you meet those expectations with a range of full-service bank card processing choices that will help you improve customer service, reduce accounts receivable, increase profits and decrease operating expenses.</p>
								<p><a href="../pdf/MerchantServices.pdf" target="_blank">Click here for complete brochure of products & services offered</a>.</p>
								<p>Access your accounts at PFCU 24 hours a day with Home Banking.</p>
                            </div>
							
							<div class="tab-pane fade" id="merchant2" role="tabpanel" aria-labelledby="merchant2-tab">
							...
							<div class="tab-pane fade" id="nextday" role="tabpanel" aria-labelledby="nextday-tab">
							...
							<div class="tab-pane fade" id="notary" role="tabpanel" aria-labelledby="notary-tab">
								<p>A PFCU Notary Public will notarize any documents pertaining to PFCU's Real Estate transactions, Affidavit of Plastic Card Forgery, Certification of Trust membership updates, and DMV forms at no fee. All other documents can be notarized for members at no fee. There will be a $2.00/notary charge for non-members. Please contact your local branchto make an appointment for this service.&sup1;</p>
								<p>&sup1;This service may not be available at all locations.</p>
								<p><strong>Account Access</strong>
									Access your accounts at PFCU 24 hours a day with Home Banking.</p>
                            </div>
							
							<div class="tab-pane fade" id="overdraft" role="tabpanel" aria-labelledby="overdraft-tab">
...
7. You may avoid the embarrassment of a “bounced” check or a declined debit card transaction.<br>
							...
							<div class="tab-pane fade" id="safe" role="tabpanel" aria-labelledby="safe-tab">
								...
								<table class="table table-bordered table-striped">
  											<thead>
   												<tr>
													<th scope="col" style="background-color: #065e2c; color: #fff;"><center><strong>Box Size</strong></center></th>
													<th scope="col" style="background-color: #065e2c; color: #fff;"><center><strong>Annual Fee</strong></center></th>
    											</tr>
  											</thead>
  											<tbody>
    											<tr>
