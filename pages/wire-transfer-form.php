...
<head>
    <title>Platinum FCU - Wire Transfer Form</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <section class="overview-block-ptb1 iq-over-black-10 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-color: #575757;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6 custom-header">Wire Transfer Form</h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active">
                                <div class="row">
									...
									<!-- form.123formbuilder.com script begins here --><script type="text/javascript" defer src="https://form.123formbuilder.com/embed/5752079.js" data-role="form" data-default-width="750px"></script><!-- form.123formbuilder.com script ends here -->
