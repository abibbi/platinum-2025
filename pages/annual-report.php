...
<head>
    <title>Platinum FCU - Annual Reports</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 iq-mtb-15">
                        ...
                        <ul class="nav nav-pills tabs-left" id="pills-tab" >
                            <li class="nav-item">
                                <a class="nav-link active" href="annual-report.php">Annual Report</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 iq-mtb-15">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active">
                                <div class="row">
                                    <div class="col-sm-12">
										<h3 class="iq-pb-25">Annual Reports</h3>
                                    </div>
                                </div>
								<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-12 col-lg-6">
										<p><a href="../pdf/AnnualReport2012.pdf" target="_blank">Annual Report 2012</a></p>
                                    </div>
                                </div>
								<div class="row">
                                    <div class="col-sm-12 col-lg-6">
										<p><a href="../pdf/AnnualReport2011.pdf" target="_blank">Annual Report 2011</a></p>
                                    </div>									
                                </div>
                            </div>
