...
<head>
    <title>Platinum FCU - Personal Loan Rates</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 iq-mtb-15">
                        ...
                        <ul class="nav nav-pills tabs-left" id="pills-tab" >
							...
							<li class="nav-item">
                                <a class="nav-link active" href="personal-rates2.php">Loan Rates</a>
                            </li>
							<li class="nav-item">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 iq-mtb-15">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active">
                                <div class="row">
                                    <div class="col-sm-12">
										<h3 class="iq-pb-25">Loan Rates</h3>
										<p><strong>Loan rates are accurate as of October 1, 2018. Rates and other terms may change at any time without prior notice. For variable rate loans a floor rate may be applicable.</strong></p>
  											...
  											<tbody>
    											<tr>
													<td><strong>New Auto Loan</strong></td>
      												<td>As low as 2.49%</td>
    											</tr>
												<tr>
													<td><strong>Pre-Owned Auto Loan</strong></td>
      												<td>As low as 2.99%</td>
    											</tr>
												<tr>
