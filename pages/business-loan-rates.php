                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 iq-mtb-15">
                        ...
                        <ul class="nav nav-pills tabs-left" id="pills-tab" >
							<li class="nav-item">
								<a class="nav-link" data-toggle="collapse" data-target="#collapseround" aria-expanded="true" aria-controls="collapseround">Business
													</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-toggle="collapse" data-target="#collapse1" aria-expanded="true" aria-controls="collapse1">Personal
													</a>
							</li>
                                ...
                                <div class="tab-pane active">	
									  ...
									  <div id="accordion2">
										...
										<div class="row">
										  ...
										  <div class="card">
											<div class="card-header" id="headinground">
												<h5 class="mb-0">
													<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseround" aria-expanded="true" aria-controls="collapseround">Business
													</button>
												</h5>
											</div>
											<div id="collapseround" class="collapse" aria-labelledby="headinground" data-parent="#accordion">
												<div class="card-body">
													<div class="row">
                                    <div class="col-sm-12">
										...
										<div class="card">
											...
											<div id="collapseOne2" class="collapse" aria-labelledby="headingOne2" data-parent="#accordion">
												<div class="card-body">
													<div class="row">
                                    <div class="col-sm-12">
										<p><strong>Loan rates are accurate as of June 18, 2020. Rates and other terms may change at any time without prior notice. For variable rate loans a floor rate may be applicable.</strong></p>
										...
										<div class="card">
											...
											<div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo2" data-parent="#accordion">
												<div class="card-body">
													<div class="row">
                                    <div class="col-sm-12">
										 <p><strong>*Dividend Rate is accurate as of July 2020. Rates and other terms may change at any time without prior notice.</strong></p>
...
$100,000 &amp; above
              ...
              <p><em>*Dividend Rate is accurate as of June 18, 2020. Rates and other terms may change at any time without prior notice. After your certificate is opened, the dividend rate is fixed for the term. A penalty is imposed for early withdrawal. Fees could reduce earnings on the account.</em></p>
          <table class="table-bordered table-striped" align="center" style="width:95%;">
				  <thead>
          	    <tr>
...
1.25%</p></td>
            ...
            Access your accounts at PFCU 24 hours a day with&nbsp;<a href="../index.php" title="Home Banking" aria-label="Home Banking Login">Home Banking </a>.</p>
													...
													<div class="row">
														<div class="col-sm-12">
															...
															<table class="table table-bordered table-striped">
																<thead>
																	<tr>
																		<th scope="col" colspan="2" style="background-color: #065e2c; color: #fff;"><center><strong>No Hassle Commercial Checking Account</strong></center></th>
																	</tr>
																</thead>
																<tbody>
																	<tr>
															...
															<table class="table table-bordered table-striped">
																<thead>
																	<tr>
																		<th scope="col" colspan="2" style="background-color: #065e2c; color: #fff;"><center><strong>Check Cashing Checking Account</strong></center></th>
																	</tr>
																</thead>
																<tbody>
																	<tr>
																	...
																	<tr>
																		<td>Cash/Coin Deposit</td>
																		<td>No Fee</td>
																	</tr>
																	<tr>
																		<td>Cash/Coin Withdrawal</td>
																		<td>No Fee</td>
																	</tr>
																	<tr>
																		<td>Home Banking</td>
															...
															<table class="table table-bordered table-striped">
																<thead>
																	<tr>
																		<th scope="col" colspan="2" style="background-color: #065e2c; color: #fff;"><center><strong>Professional/Limited Cash Checking Account</strong></center></th>
																	</tr>
																</thead>
																<tbody>
																	<tr>
									...
									<div class="row">
										...
										<div class="card">
											<div class="card-header" id="heading1">
												<h5 class="mb-0">
													<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse1" aria-expanded="true" aria-controls="collapse1">Personal
													</button>
												</h5>
											</div>
										...
										<div class="card">
											...
											<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
												<div class="card-body">
													<div class="row">
                                    <div class="col-sm-12">
										<p><strong>Loan Rates are accurate as of January 1, 2019. Rates and other terms may change at any time without prior notice. For variable rate loans a floor rate may be applicable.</strong></p>
  											...
  											<tbody>
    											<tr>
													<td><strong>New Auto Loan</strong></td>
      												<td>As low as 1.99%</td>
    											</tr>
												<tr>
													<td><strong>Pre-Owned Auto Loan</strong></td>
      												<td>As low as 2.24%</td>
    											</tr>
												<tr>
                ...
                <th bgcolor="#065e2c"><strong style="color:#fff;">Annual Percentage Yield (APY)</strong></th></tr>
				  ...
				  <tbody>
					  <tr>
          	      <td><p align="left"><strong>Share Savings</strong><br>
          	        $100 - $2,499.99<br>
          	        $2,500 - $9,999.99<br>
          	        $10,000 - $49,999.99<br>
          	        $50,000 &amp; above
...
$100,000 &amp; above
                ...
                <tr>
          	      <td><p align="left"><strong>Platinum Secure Checking</strong><br>
$500 - $999.99<br>
$1,000 - $4,999.99<br>
$5,000 &amp; above
                  </p></td>
          	      ...
          	      <td><p><br>
					  ...
					  <tr>
          	      <td><p align="left"><strong>Student Interest Checking</strong><br>
$500 - $999.99<br>
$1,000 - $4,999.99<br>
$5,000 &amp; above
                  </p></td>
                ...
                <tr>
          	      <td bgcolor="#D3D3D3"><p align="left"><strong>College Savings Plan</strong></p></td>
          	      <td bgcolor="#D3D3D3"><p>1.00%</p></td>
          	      <td bgcolor="#D3D3D3"><p>1.00%</p></td>
       	        </tr>
                <tr>
                  <td><p align="left"><strong>Diamond Jubilee Savings Account </strong></p></td>
                  <td><p>0.50%</p></td>
                  <td><p>0.50%</p></td>
                </tr>
				  </tbody>
              ...
              <p><em>*Dividend Rate is accurate as of June 2020. Rates and other terms may change at any time without prior notice. After your certificate is opened, the dividend rate is fixed for the term. A penalty is imposed for early withdrawal. Fees could reduce earnings on the account.</em></p>
          		<table class="table-bordered table-striped" align="center" style="width:95%;">
				  <thead>
          	    <tr>
          	      <th bgcolor="#065e2c"><strong style="color:#fff;">Terms</strong></th>
            ...
            Access your accounts at PFCU 24 hours a day with&nbsp;<a href="../index.php" title="Home Banking" aria-label="Home Banking Login">Home Banking </a>.</p>
                                    ...
                                    <div class="col-sm-12">
										...
										<table class="table table-bordered table-striped">
  											<thead>
   												<tr>
													<th scope="col" colspan="2" style="background-color: #065e2c; color: #fff;"><center><strong>Share/Savings Account</strong></center></th>
    											</tr>
  											</thead>
  											<tbody>
    											<tr>
										...
										<table class="table table-bordered table-striped">
  											<thead>
   												<tr>
													<th scope="col" colspan="2" style="background-color: #065e2c; color: #fff;"><center><strong>Platinum Secure Checking Account</strong></center></th>
    											</tr>
  											</thead>
  											<tbody>
    											<tr>
										...
										<table class="table table-bordered table-striped">
  											<thead>
   												<tr>
													<th scope="col" colspan="2" style="background-color: #065e2c; color: #fff;"><center><strong>Money Market Account</strong></center></th>
    											</tr>
  											</thead>
  											<tbody>
    											<tr>
															...
															<table class="table table-bordered table-striped">
																...
																<tbody>
																	...
																	<tr>
																		...
																		Loans from $5,001 to $100,000</td>
																		<td><br>$30.00 per loan<br>
																			<a href="../pdf/personal-loan-sheet.pdf" target="_blank">See Personal Loan Sheet</a></td>
																	</tr>
																	<tr>
																		<td><strong>Signature Loan</strong><br>
																		Loan up to $10,000<br>
																		Loan up to $100,000</td>
																		<td><br>$100.00 per loan<br>
																			<a href="../pdf/signature-loan-sheet.pdf" target="_blank">See Signature Loan Sheet</a></td>
																	</tr>
																	<tr>
										...
										<!--<div class="card">
											...
											<div id="collapseAuto" class="collapse" aria-labelledby="headingAuto" data-parent="#accordion">
												<div class="card-body">
													<div class="row">
														<div class="col-sm-12">
