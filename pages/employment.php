...
<head>
    <title>Platinum FCU - Employment Opportunities</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 iq-mtb-15">
                        ...
                        <ul class="nav nav-pills tabs-left" id="pills-tab" >
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="employment.php">Employment Opportunities</a>
                            </li>
							<li class="nav-item">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 iq-mtb-15">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active">
                                <div class="row">
                                    <div class="col-sm-12">
										<h3 class="iq-pb-25">Employment Opportunities</h3>
                                    </div>
                                </div>
								<div class="row">
                                    <div class="col-sm-12">
										<p><a href="http://platinumfcu.cbstalent.com/ " target="_blank"><img src="../images/employment2.png" width="388" height="112" alt="employment button"></a></p>
                                    </div>
                                </div>
                            </div>
