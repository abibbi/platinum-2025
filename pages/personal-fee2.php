...
<head>
    <title>Platinum FCU - Personal Loans Fee Schedule</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 iq-mtb-15">
                        ...
                        <ul class="nav nav-pills tabs-left" id="pills-tab" >
                            <li class="nav-item">
                                <a class="nav-link" href="personal-fee1.php">Deposit Account Fee Schedule</a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link" href="personal-rates1.php">Deposit Rates</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="personal-fee2.php">Loans Fee Schedule</a>
                            </li>
							<li class="nav-item">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 iq-mtb-15">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active">
                                <div class="row">
                                    <div class="col-sm-12">
										<h3 class="iq-pb-25">Loans Fee Schedule</h3>
