                            ...
                            <div class="tab-pane fade show active">
                                <div class="row">
                                    <div class="col-sm-12">
										...
										<p>At Platinum Federal Credit Union, we offer a wide variety of services to meet the needs of our members. We love to hear from you if there are any more services we can add that would benefit the membership at large. You can see the list of services provided on this page, please select the service to obtain further information</p>
										<p align="center"><img src="../images/servicesinx.png" alt="Guy on a tablet" class="img-fluid"></p>
                                    </div>
                                </div>
                            </div>
