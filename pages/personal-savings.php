...
<head>
    <title>Platinum FCU - Personal Savings Account</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 iq-mtb-15">
                        ...
                        <ul class="nav nav-pills tabs-left" id="pills-tab" >
							...
							<li class="nav-item">
                                <a class="nav-link active" href="personal-savings.php">Savings Account</a>
                            </li>
							<li class="nav-item">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 iq-mtb-15">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active">
                                <div class="row">
                                    <div class="col-sm-12">
										<h3 class="iq-pb-25">Savings Account</h3>
										<p>PFCU's Share/Savings Account gives you the option to earn a competitive rate of return on the excess cash you may have in your savings accounts. Open a Share/Savings Account today!</p>
										<ul class="listing-mark iq-tw-6 iq-font-black">
											<li>$20 minimum balance to open</li>
											<li>One time fee of $20 for credit union membership</li>
											...
											<li>Dividend declared and paid semi-annually</li>
										</ul>
